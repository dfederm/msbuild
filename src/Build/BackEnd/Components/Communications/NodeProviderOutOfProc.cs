...
namespace Microsoft.Build.BackEnd
{
    ...
    internal class NodeProviderOutOfProc : NodeProviderOutOfProcBase, INodeProvider
    {
        ...
        public void ShutdownAllNodes()
        {
            ...
            if (ComponentHost.BuildParameters == null)
            {
                ShutdownAllNodes(nodeReuse, reportFileAccesses: false, NodeContextTerminated);
                ShutdownAllNodes(nodeReuse, reportFileAccesses: true, NodeContextTerminated);
            }
            else
            {
                ShutdownAllNodes(nodeReuse, ComponentHost.BuildParameters.ReportFileAccesses, NodeContextTerminated);
            }
        }
