    ...
    internal static class NodeLauncher
    {
        ...
        private static Process StartDetouredProcess(string msbuildExe, string commandLineArgs, IBuildComponentHost componentHost, int nodeId)
        {
            ...
            var info = new SandboxedProcessInfo(
                ...
                // TODO dfederm: Remove if ChildProcessesToBreakawayFromSandbox is set?
            ...
            // TODO dfederm: Support shared compilation
            info.FileAccessManifest.ChildProcessesToBreakawayFromSandbox = Array.Empty<string>();
